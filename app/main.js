...
// .env file next to this script and populates process.env without overwriting
// values already present in the real environment. Secrets (API keys, OAuth
// client IDs/secrets) live in .env (gitignored), never in source. See
